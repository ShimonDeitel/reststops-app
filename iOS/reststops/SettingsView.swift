...
struct SettingsView: View {
    @AppStorage("reststops.notifyEnabled") private var notifyEnabled: Bool = true
    @AppStorage("reststops.compactMode") private var compactMode: Bool = false
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Roadside Rest Stops Pro") {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/reststops-app/privacy.html")!)
                    Text("Version 1.0")
